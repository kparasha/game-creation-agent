...
- [`04-reference-ux-learnings.md`](04-reference-ux-learnings.md) — Reference UI patterns (screenshots in `assets/reference/`); templates-first two-mode editor.
...
- GTM surface (gates control layout). Deep-crawl Reference nested menus (deferred).
